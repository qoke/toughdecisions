...
// R-12 self-grading avoidance is routed entirely through
// responseFamilies(...) feeding resolveGraders/SelectGrader at the pairwise
// step, never through response generation.
